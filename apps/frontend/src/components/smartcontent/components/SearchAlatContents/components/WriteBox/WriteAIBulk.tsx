...
const WriteAIBulk: React.FC = () => {
  return (
    <div>
      {/* STEP 1 */}
      <div>
        <div className="text-gray-800 font-bold text-[15px] mb-2">STEP 1</div>
        <div className="text-gray-700 text-[15px] mb-3">
          Download and complete the template
        </div>
        <div className="text-gray-500 text-[14px] mb-4">
          Make a copy of the template, fill the table and upload it to the form
          below. Don&apos;t forget to make the Google Sheet URL visible to
          anyone when sharing.
        </div>
        <button
          type="button"
      ...
      {/* STEP 2 */}
      <div>
        <div className="text-gray-800 font-bold text-[15px] mb-2">STEP 2</div>
        <div className="text-gray-700 text-[15px] mb-3">
        ...
        <button
          type="button"
          className="bg-[#22c55e] hover:bg-[#16a34a] text-white font-semibold px-6 py-3 rounded-lg flex items-center gap-2 text-[16px] mt-2"
        >
          Bulk Generate Articles <span className="text-lg">→</span>
        </button>
      </div>
    </div>
  );

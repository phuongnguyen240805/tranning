import { IconProps } from './components/SearchAlatContents/components/icon';
...
export const Icons = {
  ...
  Menu: () => (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className="svg-inline--fa fa-grid-2-plus sc-fb9cf6b5-0 lgtCvC"
    >
      <path
        fill="currentColor"
        d="M176 80L80 80l0 96 96 0 0-96zM80 32l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm96 304l-96 0 0 96 96 0 0-96zM80 288l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zM336 80l0 96 96 0 0-96-96 0zm-48 0c0-26.5 21.5-48 48-48l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48l0-96zm96 192c13.3 0 24 10.7 24 24l0 64 64 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-64 0 0 64c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-64-64 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l64 0 0-64c0-13.3 10.7-24 24-24z"
      ></path>
    </svg>
  ),
  Generate: () => (
    ...
    >
      <g className="fa-duotone-group">
        <path
          ...
          fill="currentColor"
          d="M16 320l0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-51.1 17.6 17.5c87.5 87.4 229.3 87.4 316.7 0c24.4-24.4 42.1-53.1 52.9-83.7c5.9-16.7-2.9-34.9-19.5-40.8s-34.9 2.9-40.8 19.5c-7.7 21.8-20.2 42.3-37.8 59.8c-62.5 62.5-163.8 62.5-226.3 0L125.6 352l50.4 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L48 288c-17.7 0-32 14.3-32 32z"
        ></path>
        <path
  ...
  InfoCircle: ({ width = 18, height = 18, className }: IconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="far"
